...
image1 = pd.read_csv ('LeViT_train_final_output.csv')
image2 = pd.read_csv ('LeViT_validation_final_output.csv')
image3 = pd.read_csv ('LeViT_test_final_output.csv')
...
model = Combination (dropout= 0.2, hidden= 8)
...
#loading the model
imgModel = Combination (dropout= 0.2, hidden= 8)
