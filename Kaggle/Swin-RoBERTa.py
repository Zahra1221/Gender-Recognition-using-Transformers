...
image1 = pd.read_csv ('swin_Kaggle_train_final.csv')
image2 = pd.read_csv ('swin_Kaggle_val_final.csv')
image3 = pd.read_csv ('swin_Kaggle_test_final.csv')
text1 = pd.read_csv (path+'/roberta_train_text_combined.csv')
text2 = pd.read_csv (path+'/roberta_test_text_combined.csv')
...
for epoch in range (epochs):
  ...
  if val_acc > best_accuracy:
    torch.save(imgModel.state_dict(), 'Swin-RoBERTa')
