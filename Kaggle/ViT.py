...
for epoch in range (epochs):
  ...
  val_acc, val_loss, val_B_Percision, val_F_Percision, val_M_Percision, val_B_Recall, val_F_Recall, val_M_Recall = eval_model(imgModel, test_loader, ce_loss, device, len(test) )
...
imgModel = ImageClassifier (vit)
imgModel = imgModel.to (device)
imgModel.load_state_dict(torch.load('ViTModel'))
