...
image1 = pd.read_csv ('ViT_Kaggle_train_final.csv')
image2 = pd.read_csv ('ViT_Kaggle_val_final.csv')
image3 = pd.read_csv ('ViT_Kaggle_test_final.csv')
...
for epoch in range (epochs):
  ...
  if val_acc > best_accuracy:
    torch.save(imgModel.state_dict(), 'ViT-RoBERTa')
    best_accuracy = val_acc

#loading the model
imgModel = Combination (dropout= 0.5, hidden= 5)
imgModel = imgModel.to (device)
imgModel.load_state_dict(torch.load('ViT-RoBERTa'))
